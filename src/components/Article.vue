...
<template>
    <div @click="count++" class="py-4">
        ...
        ipsum dolor sit amet consectetur adipisicing elit. Aut optio consectetur quibusdam
        quia, rerum quod cumque voluptatum earum temporibus et recusandae odit, architecto
        sequi, ad soluta maiores voluptatibus explicabo nisi. Accusamus iste accusantium
